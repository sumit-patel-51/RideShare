    ...
    <div class="container py-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div
                                    ...
                                    <a href="{{ route('booking.details', $booking->id) }}"
                                        class="btn btn-dark fw-bold px-4 rounded-pill">Details</a>
                                </div>
        ...
        @endif
         <div class="d-flex justify-content-between align-items-center mt-5 mb-4 pb-3 border-bottom border-2 border-dark">
            <h3 class="fw-bolder m-0">My Bookings History</h3>
        </div>
        @if($bookings->count() > 0)
            <div class="row g-4">
                @foreach($bookings as $booking)
        ...
        @else
            <div class="text-center py-5 border border-dashed rounded-5 mt-4">
                <h5 class="text-secondary fw-bold">No Booking Found</h5>
            </div>
        @endif
    </div>
@endsection